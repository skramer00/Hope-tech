...
const roles = [
  ...
  ["Camera Operator", "Coming next", "#", "Framing, movement, tally, and communication with the director."],
  ...
  return <>
    <section className="hero wrap">
      <div>
        ...
        <div className="button-row"><Link className="button primary" href="/switcher">Open Switcher Guide</Link><Link className="button secondary" href="/troubleshooting">Something went wrong</Link></div>
      </div>
